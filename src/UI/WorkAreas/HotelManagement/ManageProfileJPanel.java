...
public class ManageProfileJPanel extends javax.swing.JPanel {
    ...
    public ManageProfileJPanel(JPanel userProcessContainer, Travel travel, Hotel hotel, String username) {
        initComponents();
    ...
    public void populateInfo(){
        ...
        txtPassword.setText(hotel.getLoginCredentials().get(username));
    }
    ...
    private void initComponents() {
        ...
        add(lblManagerContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 460, -1, -1));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 570, 110, 40));

        lblLogo.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblLogo.setText("Logo:");
        add(lblLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 100, -1, -1));

        lblType.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblType.setText("Type:");
        add(lblType, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, 70, 30));

        optionsType.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(optionsType, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 500, 230, 40));
        ...
        add(imgLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 130, 158, 150));
        ...
        add(btnAttach, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 290, 110, -1));

        lblName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblName.setText("Name:");
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, -1, -1));
        ...
        add(btnRemove, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 290, -1, -1));

        lblUsername.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblUsername.setText("Username:");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, -1, -1));

        txtName.setEditable(false);
        txtName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, 230, 40));

        txtUsername.setEditable(false);
        txtUsername.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 230, 40));

        txtPassword.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 200, 230, 40));

        lblPassword.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblPassword.setText("Password:");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, -1, -1));

        txtDescription.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 250, 230, 40));

        lblDescription.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblDescription.setText("Description:");
        add(lblDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, -1, -1));

        txtHq.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtHq, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 300, 230, 40));

        lblHq.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblHq.setText("Location Headquarters:");
        add(lblHq, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, -1, -1));

        txtManagerName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, 230, 40));

        lblManagerName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblManagerName.setText("Manager Name:");
        add(lblManagerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 360, -1, -1));

        txtManagerEmail.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 400, 230, 40));

        lblManagerEmail.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblManagerEmail.setText("Manager Email:");
        add(lblManagerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 410, -1, -1));

        txtManagerContact.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 450, 230, 40));
        ...
        add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 570, 110, 40));

        jLabel1.setFont(new java.awt.Font("Trebuchet MS", 0, 48)); // NOI18N
        jLabel1.setText("Manage Profile");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 0, -1, -1));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        for(Hotel hotel: travel.getHotelDirectory().getHotelList()){
            if(hotel.getBusinessName().equals(oName) && hotel.getType().equals(type)){
                hotel.setBusinessDescription(description);
                hotel.setBusinessName(oName);
                hotel.setHeadquarter(headquarters);
                hotel.setLoginCredentials(loginCredentials);
                hotel.setLogoImage(logoImage);
                hotel.setManagerEmail(mEmail);
                hotel.setManagerName(mName);
                hotel.setManagerPhone(mContact);
            }
        }
