 ...
 * @author samik
 */
public class ChinaFinancialBoardJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    double usdRate, inrRate, cnyRate, cnyToUsd, cnyToInr, cnyToEur;
    Travel travel;

    /**
     * Creates new form ChinaFinancialBoardJPanel
     */
    ChinaFinancialBoardJPanel(JPanel userProcessContainer, Travel travel, String verification_Authority) {
        this.userProcessContainer = userProcessContainer;
        initComponents();
        currencyConverter();
        this.travel = travel;
        txtForex.setText(Double.toString(travel.getForexFinance().getForexCNY()));
    ...
    private void initComponents() {
        ...
        add(txtInput, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 130, 50));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 310, -1, -1));

        optionsCur.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        optionsCur.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "INR", "USD", "EUR" }));
        add(optionsCur, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 300, 110, 50));

        jLabel1.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel1.setText("1 CNY = ");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 50, -1, -1));
        add(txtOutput, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 300, 120, 50));

        txtInr.setEditable(false);
        txtInr.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtInr, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 110, 40));
        ...
        add(btnCompute, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 300, 110, 50));

        jTextField4.setEditable(false);
        jTextField4.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jTextField4.setText("INR");
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 40, 90, 40));

        txtUsd.setEditable(false);
        txtUsd.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        txtUsd.setToolTipText("");
        add(txtUsd, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 100, 110, 40));

        jTextField5.setEditable(false);
        jTextField5.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jTextField5.setText("USD");
        add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 100, 90, 40));

        txtEur.setEditable(false);
        txtEur.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtEur, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, 110, 40));

        jTextField6.setEditable(false);
        jTextField6.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jTextField6.setText("EUR");
        add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 160, 90, 40));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(1112, 700, 100, 50));

        lblForex.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblForex.setText("Forex Charge per CNY converted:");
        add(lblForex, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 460, -1, -1));

        txtForex.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtForex, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 450, 130, 50));
        ...
        add(btnUpdateForex, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 450, 100, 50));
        ...
        add(btnSaveForex, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 450, 80, 50));
        ...
        jLabel6.setText("->");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 310, -1, -1));

        jLabel7.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel7.setText("->");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 310, -1, -1));
    ...
    private void btnSaveForexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveForexActionPerformed
        ...
        travel.getForexFinance().setForexCNY(Double.valueOf(txtForex.getText()));
        txtForex.setEnabled(false);
        btnSaveForex.setEnabled(false);
    ...
    private void currencyConverter() {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                cnyToUsd = usdRate / cnyRate;
                cnyToInr = inrRate / cnyRate;
                cnyToEur = 1 / cnyRate;  // Since the base is EUR, use USD rate for EUR conversion

                txtUsd.setText(String.format("%.2f", cnyToUsd));
                txtInr.setText(String.format("%.2f", cnyToInr));
                txtEur.setText(String.format("%.2f", cnyToEur));
